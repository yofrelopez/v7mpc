  ...
  const divisions = [
    ...
    },
    {
      ...
      features: [
        ...
        'Custom Drinkware & Tech Gadgets',
        'Bags, Travel & Lifestyle Items',
        'Eco-Friendly & Faith-Based Products'
      ],
          ...
          {divisions.map((division, index) => {
            ...
            return (
              ...
              >
                ...
                >
                <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden border border-gray-100 h-full">
                  ...
                  <div className="p-8 lg:p-10">
                    ...
                    {/* Title */}
                    <div className="mb-6">
                      <h3 className="font-primary text-2xl lg:text-3xl font-bold text-slate-900 mb-2 group-hover:text-slate-700 transition-colors">
                        {division.title}
                      </h3>
                    ...
                    {/* Description */}
                    <p className="font-accent text-base text-slate-600 leading-relaxed mb-6">
                    ...
                    {/* CTA */}
                    <div className={`inline-flex items-center gap-2 text-transparent bg-gradient-to-r ${division.gradient} bg-clip-text font-semibold group-hover:gap-3 transition-all duration-300`}>
