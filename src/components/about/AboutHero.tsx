    ...
    <section className="relative min-h-screen overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="About V7 Marketplace Corporation"
          fill
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="font-primary text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight text-balance">
                ...
                <span className="block text-slate-200">Our Passion,</span>
                <span className="block text-slate-300">Our Commitment</span>
              </h1>
              
              <p className="font-accent text-base md:text-lg text-slate-100 leading-relaxed font-light max-w-3xl mx-auto text-balance">
                For over two decades, V7 Marketplace Corporation has been the trusted partner for government, educational, and institutional organizations across the United States. Discover our story of excellence, innovation, and unwavering commitment to our clients.
              </p>
            </div>
